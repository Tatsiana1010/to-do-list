...
export default function FormPoisk({ onFind }) {
    ...
    return (
        <form>
            ...
            <button className="buttfind"onClick={onSubmit}><svg xmlns="http://www.w3.org/2000/svg" width="19" height="13" fill="currentColor" className="bi bi-search" viewBox="0 0 16 16">
